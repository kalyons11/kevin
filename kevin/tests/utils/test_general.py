...
from kevin.utils import general


class TestUtils(TestCase):
    def test_string_method(self):
        x = 'Test-string123__:'
        y = general.strip_str(x)
    ...
    def test_reshape_func_med(self):
        ...
        out = general.reshape_image(inp, data_format='channels_last')
